...
const goalPrompt = `使用 Matt Skill $implement 完成 ${issueUrl}；完成后将提交 push 到当前开发分支；如果不存在关联 PR，创建指向 ${baseBranch} 的 Draft PR。只有实现、自测、review、commit、push 和 Draft PR 都完成后才能结束 Goal。不得执行或输出认证状态、token、credential 或其他秘密。`;
...
try {
  await request("initialize", {
    clientInfo: { name: "github-development-ticket", version: "0.1.0" },
